...
m2 = Meditation.create(date: DateTime.now.strftime('%D'), name: 'Sunrise in the mountatins', user_id: u1.id)
...
n2 = Note.create(date: DateTime.now.strftime('%D'), meditation_id: m1.id, description: "need some sleeeeep")
